...
void Obstacle::init(ID3D10Device* device, float scale, D3DXCOLOR c)
{
	md3dDevice = device;
    ...
    Vertex vertices[] =
    {
		{D3DXVECTOR3(-0.5f, 0.0f, -2.0f), D3DXVECTOR3(0, 0, -1), c, WHITE, D3DXVECTOR2(0, 0)},
		{D3DXVECTOR3(-0.5f, +5.0f, -2.0f),D3DXVECTOR3(0, 0, -1), c, WHITE, D3DXVECTOR2(0, 0)},
		{D3DXVECTOR3(+0.5f, +5.0f, -2.0f),D3DXVECTOR3(0, 0, -1), c, WHITE, D3DXVECTOR2(0, 0)},
		{D3DXVECTOR3(+0.5f, 0.0f, -2.0f), D3DXVECTOR3(0, 0, -1), c, WHITE, D3DXVECTOR2(0, 0)},
		{D3DXVECTOR3(-0.5f, 0.0f, +2.0f), D3DXVECTOR3(0, 0, -1), c, WHITE, D3DXVECTOR2(0, 0)},
		{D3DXVECTOR3(-0.5f, +5.0f, +2.0f),D3DXVECTOR3(0, 0, -1), c, WHITE, D3DXVECTOR2(0, 0)},
...
void Obstacle::init(ID3D10Device* device, float scale)
{
	md3dDevice = device;
